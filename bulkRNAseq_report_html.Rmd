...
```{r Isoform Switch Analyzer, message=FALSE, warning=F, results='hide', eval=TRUE}
targets.mod <- targets %>%
...
```{r table 3 Isoform Switches only html, eval=TRUE}
...
```{r example switchplot, fig.cap="Sample of a SwitchPlot. All SwitchPlots generated can be found in their corresponding folder.", eval=TRUE}
switchPlot(
  mySwitchList,
