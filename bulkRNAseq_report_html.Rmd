...
```{r Isoform Switch Analyzer, message=FALSE, warning=F, results='hide', eval=FALSE}
targets.mod <- targets %>%
...
```{r summary of Isoform Switch, eval=FALSE}
...
```{r example switchplot, fig.cap="Sample of a SwitchPlot. All SwitchPlots generated can be found in their corresponding folder.", eval=FALSE}
switchPlot(
  mySwitchList,
