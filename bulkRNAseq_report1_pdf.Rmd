---
title: "Report:Transcriptomic effect of Adherent Media vs Sphere Media in PDAC"
...
```{r settings}
# Change title
# Change and adapt lines 396-418, 502
# Change line 191, data source
...
# Plot
ma_plot <- ggplot(myTopHits.df, aes(x = AveExpr, y = logFC)) +
...
```{r table of functional enrichment C2 html only, eval=FALSE}
...
```{r table of functional enrichment H html only, eval=FALSE}
