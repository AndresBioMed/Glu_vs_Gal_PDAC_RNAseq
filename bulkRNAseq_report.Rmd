...
### table of filtered and normalised data
...
write.csv(mydata.df, "report/tables/table_1.csv", row.names = FALSE)
...
```{r step 3 - multivariate part 1 (data table), eval=FALSE}
```
...
write.csv(diffGenes.df, "report/tables/table_2.csv", row.names = FALSE)
```
